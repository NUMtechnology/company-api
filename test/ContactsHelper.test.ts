...
describe('ContactsHelper', () => {
  it('Can handle manually created contacts records.', async () => {
    const data = {
      ...
      contacts: [
        null,
        { method_type: 'link', '@L': 'lostbaggage', description: 'Lost Baggage' },
        {
          ...
          controller: null,
          hours: { available: null, time_zone_location: 'LON' },
        },
        {
          method_type: 'telephone',
          method_display_name: 'Telephone',
