...
describe('Company API', () => {
  it('Can lookup a NUM URI using a CompanyApi instance', async () => {
    ...
    expect(resultStr).to.equal(
      '{"object_display_name":"Organisation","object_type":"organization","name":"dummy.com","slogan":null,"contacts":[{"method_type":"link","@L":"sub-page-1","description":"John","numObject":{"object_type":"person","object_display_name":"Person","name":"John Doe","bio":null,"contacts":[{"method_type":"telephone","object_display_name":"Telephone","description_default":"Call","description":null,"prefix":"tel:","value":{"original":"123123","error":"Sms telephone number not in valid international format","display":"123123","dial":"123123"},"hours":null,"icon":"https://100px.logos.uk/telephone.media.num.uk.png"}],"method":{"telephone":{"method_type":"telephone","object_display_name":"Telephone","description_default":"Call","prefix":"tel:","icon":"https://100px.logos.uk/telephone.media.num.uk.png","list":[{"value":{"original":"123123","error":"Sms telephone number not in valid international format","display":"123123","dial":"123123"}}]}},"images":[{"name":null,"type":"headshot","variants":[{"url":"1088937600.jpg","mime":"image/jpg","width":1000,"height":1000}]}]}},{"method_type":"link","@L":"sub-page-2","description":"Jane","numObject":{"object_type":"person","object_display_name":"Person","name":"Jane Doe","bio":null,"contacts":[{"object_display_name":"Telephone","description_default":"Call","description":null,"prefix":"tel:","method_type":"telephone","value":{"original":"456456456","error":"Sms telephone number not in valid international format","display":"456456456","dial":"456456456"},"hours":null,"icon":"https://100px.logos.uk/telephone.media.num.uk.png"}],"method":{"telephone":{"object_display_name":"Telephone","description_default":"Call","prefix":"tel:","method_type":"telephone","icon":"https://100px.logos.uk/telephone.media.num.uk.png","list":[{"value":{"original":"456456456","error":"Sms telephone number not in valid international format","display":"456456456","dial":"456456456"}}]}}}}],"link":{"link":{"method_type":"link","@L":"sub-page-1","list":[{"description":"John","@L":"sub-page-1"},{"description":"Jane","@L":"sub-page-2"}]}},"images":[{"name":null,"type":"logo","variants":[{"url":"LX67y17q.jpg","mime":"image/jpg","width":1000,"height":1000}]}]}'
    );
  });
  ...
  it('Can lookup a NUM URI using a CompanyApi instance with contacts depth 1 and images depth 0', async () => {
    ...
    const resultStr = JSON.stringify(result);
    expect(resultStr).to.equal(
      '{"object_display_name":"Organisation","object_type":"organization","name":"dummy.com","slogan":null,"contacts":[{"method_type":"link","@L":"sub-page-1","description":"John"},{"method_type":"link","@L":"sub-page-2","description":"Jane"}],"link":{"link":{"method_type":"link","@L":"sub-page-1","list":[{"description":"John","@L":"sub-page-1"},{"description":"Jane","@L":"sub-page-2"}]}}}'
    );
  });
  ...
  it('Can lookup a NUM URI using a CompanyApi instance with contacts depth 1 and images depth 1', async () => {
    ...
    const resultStr = JSON.stringify(result);
    expect(resultStr).to.equal(
      '{"object_display_name":"Organisation","object_type":"organization","name":"dummy.com","slogan":null,"contacts":[{"method_type":"link","@L":"sub-page-1","description":"John"},{"method_type":"link","@L":"sub-page-2","description":"Jane"}],"link":{"link":{"method_type":"link","@L":"sub-page-1","list":[{"description":"John","@L":"sub-page-1"},{"description":"Jane","@L":"sub-page-2"}]}},"images":[{"name":null,"type":"logo","variants":[{"url":"LX67y17q.jpg","mime":"image/jpg","width":1000,"height":1000}]}]}'
    );
  });
  ...
  it('Can lookup a NUM URI using a CompanyApi instance for a record with cycles', async () => {
    ...
    const resultStr = JSON.stringify(result);
    expect(resultStr).to.equal(
      '{"object_type":"organization","object_display_name":"Organisation","name":"dummy-cyclic.com","slogan":null,"contacts":[{"method_type":"link","@L":"sub-page-1","description":"John","numObject":{"object_type":"person","object_display_name":"Person","name":"John Doe","bio":null,"contacts":[{"method_type":"link","@L":"/","description":"John"}],"link":{"link":{"method_type":"link","@L":"/","list":[{"description":"John","@L":"/"}]}}}}],"link":{"link":{"method_type":"link","@L":"sub-page-1","list":[{"description":"John","@L":"sub-page-1"}]}}}'
    );
  });
  ...
  it('Can lookup a NUM URI using a CompanyApi instance for a record with absolute NUM URIs as links', async () => {
    ...
    const resultStr = JSON.stringify(result);
    expect(resultStr).to.equal(
      '{"object_type":"organization","object_display_name":"Organisation","name":"dummy-absolute.com","slogan":null,"contacts":[{"method_type":"link","@L":"num://absolute-link.com:3/sub-page-1","description":"John","numObject":{"object_type":"person","object_display_name":"Person","name":"John Doe","bio":null,"contacts":[{"method_type":"link","@L":"/","description":"John"}],"link":{"link":{"method_type":"link","@L":"/","list":[{"description":"John","@L":"/"}]}}}}],"link":{"link":{"method_type":"link","@L":"num://absolute-link.com:3/sub-page-1","list":[{"description":"John","@L":"num://absolute-link.com:3/sub-page-1"}]}}}'
    );
  });
});
